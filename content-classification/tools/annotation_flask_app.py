  ...
  <div class="layout">
    <aside class="panel codebook">
      ...
      <div class="definition">
        ...
        <p>Count only corruption participants. Do not count actors accused solely of unrelated offenses. Allegation, investigation, charge, conviction, or explicit participation is sufficient. The allegation may be denied or unproven.</p>
        <p class="meta"><b>Mandatory two-test method:</b> Ask independently: Is there an exact passage accusing a person, officeholder, or identifiable group of people of participating in the corruption? Is there a separate exact passage accusing an organization or institution, acting in its own capacity, of participating in, directing, financing, enabling, or concealing the corruption? Map the answers mechanically: No/No = <span class="tag">no_accused_actor</span>; Yes/No = <span class="tag">individual_actor</span>; No/Yes = <span class="tag">organizational_or_institutional_actor</span>; Yes/Yes = <span class="tag">both_individual_and_organizational</span>.</p>
        <ul>
        ...
        <p class="meta"><b>Organization test:</b> An organizational actor requires a separate exact passage in which the organization itself is accused, investigated, charged, or described as carrying out, financing, directing, enabling, or concealing corruption. An organization does not count merely because its employee, leader, owner, subsidiary, member, or associate is accused.</p>
        <p class="meta">Do not count an organization merely because the accused person owns, controls, leads, or works for it; it received a contract or payment; it benefited from corruption; it appears in the same investigation; corrupt conduct occurred on its premises; it is the accused person's employer; it is a victim, investigator, regulator, court, or employer; or it was derivatively sanctioned because of its connection to an accused person. Conduct by an organization's owner, employee, or leader becomes organizational conduct only when the article says the organization participated or the person acted on its behalf. A subsidiary and parent organization are separate.</p>
