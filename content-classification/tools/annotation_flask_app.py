    ...
    <aside class="panel codebook">
      ...
      <div class="definition">
        ...
        <ul>
          ...
          <li><span class="tag">both_concrete_and_institutional</span> Both a concrete victim and a broader institutional or societal victim are explicitly visible. Record both rather than forcing one type to override the other.</li>
          <li><span class="tag">unclear</span> The article is too incomplete, ambiguous, or translation-problematic to decide.</li>
        </ul>
        <p class="meta"><b>Decision order:</b> Identify the corruption allegation. Identify the harm allegedly caused by that corruption. Identify who or what suffered the harm. Decide independently whether a concrete victim and an institutional/societal victim are present. If neither is present, code <span class="tag">no_victim</span>; if both are present, code <span class="tag">both_concrete_and_institutional</span>.</p>
        ...
        <p class="meta"><b>Causal rule:</b> Harm caused by the investigation, prosecution, scandal, resignation, reputational fallout, or institutional response does not count unless the article attributes that harm to the corruption itself. Do not infer who funded or lost money from a suspicious payment or contract when the article does not identify the deprived entity.</p>
