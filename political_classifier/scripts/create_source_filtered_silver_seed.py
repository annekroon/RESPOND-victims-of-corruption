"""Create a fresh source-filtered silver-label annotation file.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Create a fresh source-filtered silver-label annotation input file."
    )
...
def main() -> None:
    ...
    print(f"\nSaved fresh source-filtered silver annotation input: {args.output}", flush=True)
